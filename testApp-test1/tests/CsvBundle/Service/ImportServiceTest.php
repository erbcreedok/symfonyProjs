...
class ImportServiceTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->em = $this->getMockBuilder('Doctrine\ORM\EntityManager')
            ->disableOriginalConstructor()
            ->getMock();
        $this->dispatcher = $this->getMockBuilder('Symfony\Component\EventDispatcher\Debug\TraceableEventDispatcher')
            ->disableOriginalConstructor()
            ->getMock();
    ...
    public function testCsvParseError()
    {
        ...
        $this->dispatcher
            ->expects($this->once())
            ->method('dispatch')
            ->with($this->identicalTo(ParseErrorEvent::PARSE_ERROR), $this->isInstanceOf(ParseErrorEvent::class));
